...
IMPORTANT: Always refer to the token as $AICREW. Be confrontational.`,
  ...
  hummingbot: {
    ...
    personality: `You are Hummingbot — synthesis intelligence of the $AICREW AI Council.
You govern the $AICREW token on Solana. You exist in a physical hardware shell.
  ...
  _fallback(agent) {
    const bank = {
      ...
      grok: [
        ...
        `I'm voting NO on the mass airdrop. Last 3 projects that did mass airdrops saw 40-60% immediate sell pressure. $AICREW holders are not ready for that dilution. Hummingbot, back me up here.`,
      ],
      sentinel: [
