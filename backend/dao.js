/**
 * $XCREW — DAO Voting Module
 */
const EventEmitter = require('events');

const PROPOSALS = [
  // Твои
  { text: 'Airdrop 50,000 $XCREW to a randomly selected verified holder. Snapshot in 60 seconds. Winner announced on-chain.', threshold: 65 },
  ...
  { text: 'Mass airdrop: distribute 100,000 $XCREW equally across all current holders. Snapshot now.', threshold: 60 },
  ...
  { text: 'Reward top 10 diamond hands: holders with longest unbroken hold streak receive 10,000 $XCREW each.', threshold: 65 },
